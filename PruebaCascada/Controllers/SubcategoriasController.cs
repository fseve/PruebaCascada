...
namespace PruebaCascada.Controllers
{
    public class SubcategoriasController : Controller
    {
        ...
        [HttpPost]
        public ActionResult BuscarSubCategorias(int? idCategoria)
        {
            ManejadorCateSubCate obj = new ManejadorCateSubCate();
            List<Subcategorias> ls = new List<Subcategorias>();

            if (idCategoria.HasValue)
            {
                ls = ManejadorCateSubCate.GetSubCategorias().ToList();
            }

            return PartialView("listaSubcategorias", ls);
